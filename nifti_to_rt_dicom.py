...
rtstruct = RTStructBuilder.create_new(
    dicom_series_path=r"D:\stgl_rt_dicom\storm_dicom\storm_to_brats\STGL001\MR T1-post")

# Your code to generate the segmentation mask
nii = nib.load(r"D:\stgl_rt_dicom\nifti_ensemble\STGL001_pred.nii").get_fdata()
...
rtstruct.save('export_dicom\STGL001')
